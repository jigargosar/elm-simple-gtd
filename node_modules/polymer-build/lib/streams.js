...
class VinylReaderTransform extends AsyncTransformStream {
    ...
    _transformIter(paths) {
        return __asyncGenerator(this, arguments, function* _transformIter_1() {
            try {
                for (var paths_1 = __asyncValues(paths), paths_1_1 = yield ["await", paths_1.next()]; !paths_1_1.done; paths_1_1 = yield ["await", paths_1.next()]) {
                    const filePath = paths_1_1.value;
                    yield ["yield", new File({ path: filePath, contents: yield ["await", mz_1.fs.readFile(filePath)] })];
                }
            }
            catch (e_2_1) { e_2 = { error: e_2_1 }; }
            finally {
                try {
                    if (paths_1_1 && !paths_1_1.done && (_a = paths_1.return)) yield ["await", _a.call(paths_1)];
                }
