...
createProjectMenuConfig : EditTodoFormModel -> AppModel -> Menu.Config Project.Model Msg.Msg
...
createContextMenuConfig : EditTodoFormModel -> AppModel -> Menu.Config Context.Model Msg.Msg
