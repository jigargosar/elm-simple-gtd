...
const js_utils_1 = require("../polymer/js-utils");
...
class ClassScanner {
    ...
    _makeElementFeature(element, document) {
        ...
        if (astNode.type === 'ClassExpression' ||
            ...
            methods = polymer2_config_1.getMethods(astNode, document);
        }
...
class ClassFinder {
    ...
    _classFound(name, doc, astNode) {
        ...
        this.classes.push(new model_1.ScannedClass(namespacedName, name, astNode, doc, (doc.description || '').trim(), this._document.sourceRangeForNode(astNode), new Map(), polymer2_config_1.getMethods(astNode, this._document), this._getExtends(astNode, doc, warnings, this._document), jsdoc.getMixinApplications(this._document, astNode, doc, warnings), js_utils_1.getOrInferPrivacy(namespacedName || '', doc), warnings, jsdoc.hasTag(doc, 'abstract'), jsdoc.extractDemos(doc)));
        if (astNode.type === 'ClassExpression') {
