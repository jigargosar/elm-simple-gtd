 ...
 */
class ScannedClass {
    constructor(className, localClassName, astNode, jsdoc, description, sourceRange, properties, methods, superClass, mixins, privacy, warnings, abstract, demos) {
        this.name = className;
...
class Class {
    constructor(init, document) {
        ...
        for (const method of this.methods) {
            ...
            method.privacy = js_utils_1.getOrInferPrivacy(method.name, method.jsdoc);
        }
    }
    /**
    ...
    _overwriteInherited(existing, overriding, overridingClassName, applyingSelf = false) {
        ...
        const existingIndexByName = new Map(existing.map((e, idx) => [e.name, idx]));
