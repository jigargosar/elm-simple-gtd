        ...
        if (hasMixinFunctionDocTag(parentJsDocs)) {
            ...
            if (namespacedName) {
                this._currentMixin = new polymer_element_mixin_1.ScannedPolymerElementMixin({
                    ...
                    privacy: js_utils_1.getOrInferPrivacy(namespacedName, parentJsDocs),
                    jsdoc: parentJsDocs,
        ...
        if (hasMixinFunctionDocTag(nodeJsDocs)) {
            ...
            if (namespacedName) {
                this._currentMixin = new polymer_element_mixin_1.ScannedPolymerElementMixin({
                    ...
                    summary: (summaryTag && summaryTag.description) || '',
                    privacy: js_utils_1.getOrInferPrivacy(namespacedName, nodeJsDocs),
                    jsdoc: nodeJsDocs,
            ...
            if (node.declarations.length === 1) {
                ...
                if (name) {
                    ...
                    mixin = new polymer_element_mixin_1.ScannedPolymerElementMixin({
                        ...
                        summary: (summaryTag && summaryTag.description) || '',
                        privacy: js_utils_1.getOrInferPrivacy(namespacedName, docs),
                        jsdoc: docs,
