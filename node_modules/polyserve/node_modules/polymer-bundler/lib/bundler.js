...
class Bundler {
    ...
    bundle(manifest) {
        return __awaiter(this, void 0, void 0, function* () {
            const bundledDocuments = new Map();
    ...
    _bundleDocument(docBundle, bundleManifest) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.enableScriptInlining) {
                yield this._inlineScripts(document, ast);
            }
            if (this.enableCssInlining) {
                yield this._inlineStylesheetLinks(document, ast);
                yield this._inlineStylesheetImports(document, ast);
            }
     ...
     */
    _inlineScripts(document, ast) {
        return __awaiter(this, void 0, void 0, function* () {
            const scriptImports = dom5.queryAll(ast, matchers.externalJavascript);
            for (const externalScript of scriptImports) {
                yield importUtils.inlineScript(this.analyzer, document, externalScript, this.sourcemaps);
            }
        });
    }
    /**
     ...
     */
    _inlineStylesheetImports(document, ast) {
        return __awaiter(this, void 0, void 0, function* () {
            const cssImports = dom5.queryAll(ast, matchers.stylesheetImport);
            for (const cssLink of cssImports) {
                const style = yield importUtils.inlineStylesheet(this.analyzer, document, cssLink);
                if (style) {
     ...
     * relatively transposed as necessary.
     */
    _inlineStylesheetLinks(document, ast) {
        return __awaiter(this, void 0, void 0, function* () {
            const cssLinks = dom5.queryAll(ast, matchers.externalStyle);
            for (const cssLink of cssLinks) {
                yield importUtils.inlineStylesheet(this.analyzer, document, cssLink);
            }
        });
    }
    /**
