...
class ElementVisitor {
    ...
    enterClassDeclaration(node, _) {
        ...
        this.element = new polymer_element_1.ScannedPolymerElement({
            ...
            privacy: js_utils_1.getOrInferPrivacy(className, docs),
    ...
    enterMethodDefinition(node, _parent) {
        ...
        if (node.kind === 'method') {
            const methodDesc = js_utils_1.toScannedMethod(prop, this.document.sourceRangeForNode(node), this.document);
        ...
        if (callee.type === 'Identifier') {
            if (callee.name === 'Polymer') {
                ...
                this.element = new polymer_element_1.ScannedPolymerElement({
                    ...
                    privacy: js_utils_1.getOrInferPrivacy('', jsDoc),
            ...
            for (const prop of node.properties) {
                ...
                try {
                    ...
                    if (prop.kind === 'get') {
                        ...
                        const scannedPolymerMethod = js_utils_1.toScannedMethod(prop, this.document.sourceRangeForNode(prop), this.document);
