...
export declare class Class implements Feature {
     ...
     */
    protected _overwriteInherited<P extends PropertyLike>(existing: P[], overriding: ImmutableArray<P>, overridingClassName: string | undefined, applyingSelf?: boolean): void;
    /**
    ...
    protected _inheritFrom(superClass: Class | ElementMixin): void;
    emitMetadata(): object;
