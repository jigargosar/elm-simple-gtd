...
suite('Analyzer', () => {
    ...
    ;
    setup(() => {
        const underlyingUrlLoader = new fs_url_loader_1.FSUrlLoader(__dirname);
...
~~`);
        ...
        test('creates a document warning when a behavior cannot be found in that document', () => __awaiter(this, void 0, void 0, function* () {
            const document = yield analyzeDocument('static/html-missing-behaviors.html');
    ...
    suite('_parse()', () => {
        ...
        test('returns a Promise that rejects for non-existant files', () => __awaiter(this, void 0, void 0, function* () {
            const context = yield getContext(analyzer);
            yield chai_1.assert.isRejected(context['_parse']('static/not-found'));
        }));
    });
