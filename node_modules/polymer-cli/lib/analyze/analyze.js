...
const generate_analysis_1 = require("polymer-analyzer/lib/generate-analysis");
...
function analyze(root, inputs) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (inputs == null || inputs.length === 0) {
            ...
            return generate_analysis_1.generateAnalysis(_package, '', isNotTest);
        }
        else {
            const analysis = yield analyzer.analyze(inputs);
            return generate_analysis_1.generateAnalysis(analysis, '', isNotTest);
        }
    });
}
