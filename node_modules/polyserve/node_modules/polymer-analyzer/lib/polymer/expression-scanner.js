...
class DatabindingExpression {
    constructor(sourceRange, expressionText, ast, limitation) {
        this.warnings = [];
        /**
...
class AttributeDatabindingExpression extends DatabindingExpression {
    constructor(astNode, isCompleteBinding, direction, eventName, attribute, sourceRange, expressionText, ast) {
...
class TextNodeDatabindingExpression extends DatabindingExpression {
    constructor(direction, astNode, sourceRange, expressionText, ast) {
        super(sourceRange, expressionText, ast, 'full');
...
class JavascriptDatabindingExpression extends DatabindingExpression {
    constructor(astNode, sourceRange, expressionText, ast, kind) {
...
function extractDataBindingsFromTextNode(document, node, results, warnings) {
    ...
    for (const dataBinding of dataBindings) {
        ...
        if (parseResult.type === 'failure') {
            ...
            const expression = new TextNodeDatabindingExpression(dataBinding.direction, node, sourceRange, dataBinding.expressionText, parseResult.program);
...
function extractDataBindingsFromAttr(document, node, attr, results, warnings) {
    ...
    for (const dataBinding of dataBindings) {
        ...
        if (parseResult.type === 'failure') {
            ...
            const expression = new AttributeDatabindingExpression(node, isFullAttributeBinding, dataBinding.direction, eventName, attr, sourceRange, expressionText, parseResult.program);
            for (const warning of expression.warnings) {
                warnings.push(warning);
            }
            results.push(expression);
...
function parseExpressionInJsStringLiteral(document, stringLiteral, kind) {
    ...
    if (parsed && parsed.type === 'failure') {
        ...
        result.databinding = new JavascriptDatabindingExpression(stringLiteral, sourceRange, expressionText, parsed.program, kind);
