...
export declare abstract class DatabindingExpression {
    ...
    constructor(sourceRange: SourceRange, expressionText: string, ast: estree.Program, limitation: ExpressionLimitation);
    /**
...
export declare class AttributeDatabindingExpression extends DatabindingExpression {
    ...
    constructor(astNode: parse5.ASTNode, isCompleteBinding: boolean, direction: '{' | '[', eventName: string | undefined, attribute: parse5.ASTAttribute, sourceRange: SourceRange, expressionText: string, ast: estree.Program);
}
export declare class TextNodeDatabindingExpression extends DatabindingExpression {
    ...
    readonly astNode: parse5.ASTNode;
    readonly databindingInto: string;
    constructor(direction: '{' | '[', astNode: parse5.ASTNode, sourceRange: SourceRange, expressionText: string, ast: estree.Program);
}
export declare class JavascriptDatabindingExpression extends DatabindingExpression {
    readonly astNode: estree.Node;
    readonly databindingInto: string;
    constructor(astNode: estree.Node, sourceRange: SourceRange, expressionText: string, ast: estree.Program, kind: ExpressionLimitation);
}
/**
