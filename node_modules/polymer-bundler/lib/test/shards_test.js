...
suite('Bundler', () => {
    ...
    suite('Sharded builds', () => {
        test('with 3 entrypoints, all deps are in their places', () => __awaiter(this, void 0, void 0, function* () {
            const docs = yield bundleMultiple([common, entrypoint1, entrypoint2], { strategy: bundle_manifest_1.generateSharedDepsMergeStrategy(2) });
            assert.equal(docs.size, 4);
            const commonDoc = docs.get(common).ast;
        ...
        test('with 2 entrypoints and shell, all deps in their places', () => __awaiter(this, void 0, void 0, function* () {
            const docs = yield bundleMultiple([shell, entrypoint1, entrypoint2], { strategy: bundle_manifest_1.generateShellMergeStrategy(shell, 2) });
            assert.equal(docs.size, 3);
            const shellDoc = docs.get(shell).ast;
