...
class ElementVisitor {
    ...
    enterMethodDefinition(node, _parent) {
        ...
        if (node.kind === 'get') {
            ...
            const propDesc = js_utils_1.toScannedPolymerProperty(prop, this.document.sourceRangeForNode(node));
        ...
        if (node.kind === 'method') {
            const methodDesc = js_utils_1.toScannedMethod(prop, this.document.sourceRangeForNode(node));
