...
export declare function getStaticGetterValue(node: estree.ClassDeclaration | estree.ClassExpression, name: string): estree.Expression | undefined;
...
export declare function getMethods(node: estree.Node, document: JavaScriptDocument): ScannedMethod[];
