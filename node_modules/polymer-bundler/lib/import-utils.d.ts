 ...
 */
export declare function inlineScript(analyzer: Analyzer, document: Document, scriptTag: ASTNode, enableSourcemaps: boolean): Promise<string | undefined>;
/**
 * Inlines the contents of the stylesheet returned by the link tag's href url
 * into a style tag and removes the link tag.
 */
export declare function inlineStylesheet(analyzer: Analyzer, document: Document, cssLink: ASTNode): Promise<ASTNode | undefined>;
/**
